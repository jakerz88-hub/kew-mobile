...
function makeStyles(c: ColorPalette) {
  return StyleSheet.create({
    ...
    sectionTitle:     { fontSize: FontSize.xxs, color: c.warmMid, textTransform: "uppercase", letterSpacing: 0.8, fontFamily: FontFamily.sansMedium, paddingHorizontal: Spacing.md, paddingTop: Spacing.s10, paddingBottom: Spacing.xs },
    row:              { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: Spacing.md, paddingVertical: Spacing.s10 },
