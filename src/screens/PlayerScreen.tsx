    ...
    return (
      <SafeAreaView style={styles.container}>
        <TouchableOpacity onPress={() => router.back()} style={styles.backBtn}>
          <SansText style={styles.backText}>Back</SansText>
        </TouchableOpacity>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <YoutubePlayer
          ...
          initialPlayerParams={{ controls: true, rel: false, modestbranding: 1 }}
        ...
        <View style={styles.skipSection}>
          ...
          <SansText style={styles.skipConsequence}>This will move the current video to the end of your queue.</SansText>
          <TouchableOpacity
