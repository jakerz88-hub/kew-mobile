...
import { KewLogo, SansText, SerifText, Divider, ThumbPlaceholder, EmptyState, ErrorBanner } from "../../src/components/UI";
import { Colors, FontFamily, FontSize, Spacing, Radius } from "../../src/types/theme";
import { formatDuration, timeAgo } from "../../src/types";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          !loading ? (
            <EmptyState icon="H" title="Nothing watched yet" subtitle="Videos you finish will appear here. Go watch something!" />
          ) : null
        }
