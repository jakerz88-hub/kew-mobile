      ...
      <View style={styles.inner}>
        ...
        {nextEntry ? (
          <View style={styles.nextSection}>
            ...
            <TouchableOpacity style={styles.nextCard} onPress={() => router.replace("/player")} activeOpacity={0.85}>
        ...
        <TouchableOpacity style={styles.backToQueue} onPress={() => router.replace("/")}>
