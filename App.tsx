...
import { QueueTabIcon, BrowseTabIcon, ExploreTabIcon, JournalTabIcon, LogoMark } from "./src/components/TabIcons";
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{ tabBarIcon: ({ color }) => <JournalTabIcon color={color} /> }}
      />
    </Tab.Navigator>
  );
}
